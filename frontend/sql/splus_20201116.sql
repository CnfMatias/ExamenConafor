...
CREATE TABLE `c_publicidad`  (
  ...
  `nombre` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `activo` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `c_publicidad` VALUES (1, 'new', '1');
...
CREATE TABLE `clientes`  (
  ...
  `municipio_id` smallint(11) NULL DEFAULT NULL,
  `activo` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '1',
...
-- Records of clientes
-- ----------------------------
INSERT INTO `clientes` VALUES (1, 'MANUEL', 'condesa', '1989', '340', 'mANZA Y DURAZNO', '0', 44900, '', 2, '33-1098-394', NULL, NULL, '1', NULL, NULL, NULL);
INSERT INTO `clientes` VALUES (14, 'MANUEL', 'FRESNO', '1989', '340', 'mANZA', '0', 44900, '', 2, '33-1098-394', NULL, NULL, '1', NULL, NULL, NULL);
INSERT INTO `clientes` VALUES (15, 'Jose', 'FRESNO', '1989', '340', 'mANZA Y DURAZNO', '0', 44900, '', 2, '33-1098-394', NULL, NULL, '1', NULL, NULL, NULL);
...
INSERT INTO `empleados` VALUES (8, 'Raul', 'GDL', '', '0000-00-00', '80592b9914447a686b0b69f87b0972f2.jpeg', 4, 1, 500.00, 0, 0, NULL, 'rikmatt23@gmail.com', 7, '1', 5000.00, 15);
INSERT INTO `empleados` VALUES (9, 'monica', '', '', '0000-00-00', '77d2f18ac6549e8a9d3c28d31951eb52.jpeg', 4, 0, 0.00, 0, 0, NULL, '', 0, '1', 7000.00, 10);
...
-- Records of polizas
-- ----------------------------
INSERT INTO `polizas` VALUES (1, 15, 800, '2020-11-01', '2020-11-04', 1, 3);
INSERT INTO `polizas` VALUES (2, 1, 0, '0000-00-00', '0000-00-00', 1, 2);
...
CREATE TABLE `r_cliente_tel`  (
  ...
  `usuario_creacion` smallint(11) NULL DEFAULT NULL,
  `fecha_hora_creacion` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_equipos` AS SELECT
	id,
	nombre,
	CASE 
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_horarios` AS SELECT
	id,
	nombre,
	CASE 
	WHEN dia_inicio = 0 THEN 'Domingo'
	WHEN dia_inicio = 1 THEN 'Lunes'
	WHEN dia_inicio = 2 THEN 'Martes'
	WHEN dia_inicio = 3 THEN 'Miercoles'
	WHEN dia_inicio = 4 THEN 'Jueves'
	WHEN dia_inicio = 5 THEN 'Viernes'
	WHEN dia_inicio = 6 THEN 'Sabado'
	END AS 'dia_inicio',
	CASE 
	WHEN dia_final = 0 THEN 'Domingo'
	WHEN dia_final = 1 THEN 'Lunes'
	WHEN dia_final = 2 THEN 'Martes'
	WHEN dia_final = 3 THEN 'Miercoles'
	WHEN dia_final = 4 THEN 'Jueves'
	WHEN dia_final = 5 THEN 'Viernes'
	WHEN dia_final = 6 THEN 'Sabado'
	END AS 'dia_final',
	CASE 
	WHEN activo = 1 THEN 'Activo'
	ELSE 'Inactivo'
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `vw_marca` AS SELECT
	id,
	nombre,
	CASE 
	WHEN activo = 1 THEN 'Activo'
